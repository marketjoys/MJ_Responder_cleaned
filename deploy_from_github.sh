...
print_summary() {
    ...
    echo -e "   View logs with journalctl:"
    echo -e "   Backend:      ${YELLOW}sudo journalctl -u backend-mj-responder.service -f${NC}"
    echo -e "   RQ Worker:    ${YELLOW}sudo journalctl -u rq-worker-mj-responder.service -f${NC}"
    echo -e "   RQ Scheduler: ${YELLOW}sudo journalctl -u rq-scheduler-mj-responder.service -f${NC}"
    echo -e "   Redis:        ${YELLOW}sudo journalctl -u redis-mj-responder.service -f${NC}"
    echo ""
    
    echo -e "${BLUE}🔄 Systemd Service Management:${NC}"
    echo -e "   Services are managed by systemd and will auto-start on boot"
    echo -e "   Service names:"
