...
### Domain
**Application URL:** `https://codebase-refresh-7.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://codebase-refresh-7.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://codebase-refresh-7.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://codebase-refresh-7.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://codebase-refresh-7.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://codebase-refresh-7.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://codebase-refresh-7.preview.emergentagent.com/oauth/google/callback"
```
