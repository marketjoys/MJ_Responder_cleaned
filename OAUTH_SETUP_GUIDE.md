...
### Domain
**Application URL:** `https://reminder-sync-3.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://reminder-sync-3.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://reminder-sync-3.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://reminder-sync-3.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://reminder-sync-3.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://reminder-sync-3.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://reminder-sync-3.preview.emergentagent.com/oauth/google/callback"
```
