...
### Domain
**Application URL:** `https://setup-redis-sync.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://setup-redis-sync.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://setup-redis-sync.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://setup-redis-sync.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://setup-redis-sync.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://setup-redis-sync.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://setup-redis-sync.preview.emergentagent.com/oauth/google/callback"
```
