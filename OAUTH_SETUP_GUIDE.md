...
### Domain
**Application URL:** `https://sync-restart-all.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://sync-restart-all.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://sync-restart-all.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://sync-restart-all.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://sync-restart-all.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://sync-restart-all.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://sync-restart-all.preview.emergentagent.com/oauth/google/callback"
```
