...
### Domain
**Application URL:** `https://agent-sync-workflow.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://agent-sync-workflow.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://agent-sync-workflow.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://agent-sync-workflow.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://agent-sync-workflow.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://agent-sync-workflow.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://agent-sync-workflow.preview.emergentagent.com/oauth/google/callback"
```
