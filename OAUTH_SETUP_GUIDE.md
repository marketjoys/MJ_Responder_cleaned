...
### Domain
**Application URL:** `https://component-check-2.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://component-check-2.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://component-check-2.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://component-check-2.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://component-check-2.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://component-check-2.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://component-check-2.preview.emergentagent.com/oauth/google/callback"
```
