...
### Domain
**Application URL:** `https://email-sync-enhance.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://email-sync-enhance.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://email-sync-enhance.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://email-sync-enhance.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://email-sync-enhance.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://email-sync-enhance.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://email-sync-enhance.preview.emergentagent.com/oauth/google/callback"
```
