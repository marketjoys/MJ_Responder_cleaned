...
### Domain
**Application URL:** `https://worker-restart-hub.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://worker-restart-hub.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://worker-restart-hub.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://worker-restart-hub.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://worker-restart-hub.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://worker-restart-hub.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://worker-restart-hub.preview.emergentagent.com/oauth/google/callback"
```
