...
### Domain
**Application URL:** `https://codebase-sync-33.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://codebase-sync-33.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://codebase-sync-33.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://codebase-sync-33.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://codebase-sync-33.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://codebase-sync-33.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://codebase-sync-33.preview.emergentagent.com/oauth/google/callback"
```
