...
### Domain
**Application URL:** `https://outlook-sync-fix.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://outlook-sync-fix.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://outlook-sync-fix.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://outlook-sync-fix.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://outlook-sync-fix.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://outlook-sync-fix.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://outlook-sync-fix.preview.emergentagent.com/oauth/google/callback"
```
