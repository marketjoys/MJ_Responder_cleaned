...
### Domain
**Application URL:** `https://auth-calendar-fix.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://auth-calendar-fix.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://auth-calendar-fix.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://auth-calendar-fix.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://auth-calendar-fix.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://auth-calendar-fix.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://auth-calendar-fix.preview.emergentagent.com/oauth/google/callback"
```
