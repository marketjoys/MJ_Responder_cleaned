...
### Domain
**Application URL:** `https://knowledge-base-init.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://knowledge-base-init.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://knowledge-base-init.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://knowledge-base-init.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://knowledge-base-init.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://knowledge-base-init.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://knowledge-base-init.preview.emergentagent.com/oauth/google/callback"
```
