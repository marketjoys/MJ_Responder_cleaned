...
### Domain
**Application URL:** `https://email-cycle-fixer.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://email-cycle-fixer.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://email-cycle-fixer.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://email-cycle-fixer.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://email-cycle-fixer.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://email-cycle-fixer.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://email-cycle-fixer.preview.emergentagent.com/oauth/google/callback"
```
