...
### Domain
**Application URL:** `https://google-sync-app.preview.emergentagent.com`

### OAuth Redirect URIs
- **Google OAuth:** `https://google-sync-app.preview.emergentagent.com/oauth/google/callback`
- **Microsoft OAuth:** `https://google-sync-app.preview.emergentagent.com/oauth/microsoft/callback`
...
5. Under **Platform configurations** → **Web**, add/update the redirect URI:
   ```
   https://google-sync-app.preview.emergentagent.com/oauth/microsoft/callback
   ```
...
5. Under **Authorized redirect URIs**, add/update:
   ```
   https://google-sync-app.preview.emergentagent.com/oauth/google/callback
   ```
...
MICROSOFT_REDIRECT_URI="https://google-sync-app.preview.emergentagent.com/oauth/microsoft/callback"
...
GOOGLE_REDIRECT_URI="https://google-sync-app.preview.emergentagent.com/oauth/google/callback"
```
