...
# Configuration
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://email-flow-repair-1.preview.emergentagent.com')
...
class GoogleOAuthTester:
    ...
    def test_oauth_credentials_configuration(self):
        ...
        try:
            ...
            expected_redirect_uri = "https://email-flow-repair-1.preview.emergentagent.com/oauth/google/callback"
