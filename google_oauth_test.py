...
# Configuration
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://auth-fix-46.preview.emergentagent.com')
...
class GoogleOAuthTester:
    ...
    def test_oauth_credentials_configuration(self):
        ...
        try:
            ...
            expected_redirect_uri = "https://auth-fix-46.preview.emergentagent.com/oauth/google/callback"
