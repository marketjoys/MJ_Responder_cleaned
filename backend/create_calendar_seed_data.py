...
TechCorp Solutions""",
    ...
    {
        "id": str(uuid.uuid4()),
        "message_id": f"<{str(uuid.uuid4())}@consulting.com>",
        "user_id": USER_ID,
        "account_id": ACCOUNT_ID,
        "thread_id": str(uuid.uuid4()),
...
Sarah""",
    ...
    {
        "id": str(uuid.uuid4()),
        "message_id": f"<{str(uuid.uuid4())}@startupxyz.io>",
        "user_id": USER_ID,
        "account_id": ACCOUNT_ID,
        "thread_id": str(uuid.uuid4()),
...
StartupXYZ""",
    ...
    {
        "id": str(uuid.uuid4()),
        "message_id": f"<{str(uuid.uuid4())}@webagency.com>",
        "user_id": USER_ID,
        "account_id": ACCOUNT_ID,
        "thread_id": str(uuid.uuid4()),
...
WebAgency Pro""",
    ...
    {
        "id": str(uuid.uuid4()),
        "message_id": f"<{str(uuid.uuid4())}@conference.com>",
        "user_id": USER_ID,
        "account_id": ACCOUNT_ID,
        "thread_id": str(uuid.uuid4()),
