        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="shadow-lg border-l-4 border-l-blue-500">
            <CardHeader>
              ...
              <CardDescription>
                Secure access to Gmail without storing passwords
              </CardDescription>
            </CardHeader>
            <CardContent>
              {oauthStatus?.is_authorized ? (
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-slate-600">
                    <p><strong>Account:</strong> {oauthStatus.user_name}</p>
                    <p><strong>Email:</strong> {oauthStatus.user_email}</p>
                    <p><strong>Services:</strong> {oauthStatus.authorized_services?.join(', ') || 'None'}</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm" 
                    onClick={revokeGoogleOAuth}
                    disabled={loading}
                    className="text-red-600 hover:text-red-700"
                  >
                    {loading ? <RefreshCw className="h-4 w-4 mr-2 animate-spin" /> : <PowerOff className="h-4 w-4 mr-2" />}
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-slate-600">
                    Authorize Google OAuth to create Gmail accounts
                  </p>
                  <Button 
                    onClick={initiateGoogleOAuth}
                    disabled={loading}
          ...
          <Card className="shadow-lg border-l-4 border-l-orange-500">
            <CardHeader>
              ...
              <CardDescription>
                Secure access to Outlook without storing passwords
              </CardDescription>
            </CardHeader>
            <CardContent>
              {microsoftOauthStatus?.is_authorized ? (
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <span className="text-green-700 font-medium">Authorized</span>
                  ...
                  <div className="text-sm text-slate-600">
                    <p><strong>Account:</strong> {microsoftOauthStatus.user_name}</p>
                    <p><strong>Email:</strong> {microsoftOauthStatus.user_email}</p>
                    <p><strong>Services:</strong> {microsoftOauthStatus.authorized_services?.join(', ') || 'None'}</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm" 
                    onClick={revokeMicrosoftOAuth}
                    disabled={loading}
                    className="text-red-600 hover:text-red-700"
                  >
                    {loading ? <RefreshCw className="h-4 w-4 mr-2 animate-spin" /> : <PowerOff className="h-4 w-4 mr-2" />}
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-slate-600">
                    Authorize Microsoft OAuth to create Outlook accounts
                  </p>
                  <Button 
